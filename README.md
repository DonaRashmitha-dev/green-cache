...
#### English — First Query (Cache Miss → LLM Called)
![English Query](screenshots/dashboard_1_english.png)

#### English — Full Response
![English Response](screenshots/dashboard_2_english.png)

#### English — Follow-up Query (Cache Hit → Instant)
![English Hit](screenshots/dashboard_3_english.png)

#### Spanish — Cache Hit + Auto-Translated
![Spanish Query](screenshots/dashboard_1_spanish.png)
![Spanish Response](screenshots/dashboard_2_spanish.png)

#### Chinese — Cache Hit + Auto-Translated
![Chinese Query](screenshots/dashboard_1_chinese.png)
![Chinese Response](screenshots/dashboard_2_chinese.png)

#### Japanese — Cache Hit + Auto-Translated
![Japanese Query](screenshots/dashboard_1_japanese.png)
![Japanese Response](screenshots/dashboard_2_japanese.png)

> One English answer cached → served instantly in Spanish, Chinese, and Japanese. Zero extra LLM calls.

---

### 📊 Stats Dashboard
![Stats Page](screenshots/dashboard_stats.png)
*82.9% hit rate · 35 total requests · 29 cache hits · 8,685 tokens saved · ~28× faster with cache*

### 🌍 Environmental Impact Dashboard
![Impact Page](screenshots/dashboard_impact.png)
*Real-time water, energy, and carbon savings tracked per session*

### ⚙️ Settings Page
![Settings Page](screenshots/dashboard_settings.png)
